...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_279f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_279(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4102U, 4103U };
  ...
  static size_t selector_X_[3] = { 162U, 170U, 171U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_279xnplus1;
