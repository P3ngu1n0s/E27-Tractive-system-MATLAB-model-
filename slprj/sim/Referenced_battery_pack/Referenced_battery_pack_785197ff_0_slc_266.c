...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_266f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_266(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4119U, 4120U };
  ...
  static size_t selector_X_[3] = { 237U, 247U, 248U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_266xnplus1;
