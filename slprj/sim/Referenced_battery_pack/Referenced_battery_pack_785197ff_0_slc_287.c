...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_287f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_287(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4093U, 4094U };
  ...
  static size_t selector_X_[3] = { 118U, 126U, 127U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_287xnplus1;
