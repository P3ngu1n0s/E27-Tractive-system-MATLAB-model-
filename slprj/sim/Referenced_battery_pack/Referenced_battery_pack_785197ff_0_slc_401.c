...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_401jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_401fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_401(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 240U, 246U, 957U, 968U, 1090U, 1101U };
  ...
  static size_t selector_X_[15] = { 870U, 932U, 940U, 941U, 943U, 944U, 945U,
    946U, 947U, 998U, 1000U, 1001U, 1002U, 1003U, 1004U };
