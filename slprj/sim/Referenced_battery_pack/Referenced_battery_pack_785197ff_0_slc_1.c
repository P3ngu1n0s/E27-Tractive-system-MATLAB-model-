...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_1f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_1(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4065U, 4066U };
  ...
  static size_t selector_X_[3] = { 2791U, 2798U, 2799U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_1xnplus1;
