...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_245f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_245(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4154U, 4155U };
  ...
  static size_t selector_X_[3] = { 400U, 407U, 408U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_245xnplus1;
