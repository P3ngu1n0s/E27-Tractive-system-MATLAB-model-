...
int32_T Referenced_battery_pack_785197ff_0_slc_346fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_142 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_142 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based37_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int426 + t42->mX.mX[4UL]) +
