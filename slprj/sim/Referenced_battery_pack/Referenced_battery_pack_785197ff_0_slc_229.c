...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_229f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_229(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4185U, 4186U };
  ...
  static size_t selector_X_[3] = { 533U, 540U, 541U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_229xnplus1;
