...
int32_T Referenced_battery_pack_785197ff_0_slc_312jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    zc_int825 = 8.200000000000002E-8;
  } else {
    zc_int825 = t12[0UL];
  }

  out->mJNL.mX[0UL] = -zc_int825;
  out->mJNL.mX[1UL] = zc_int816;
  (void)sys;
  (void)out;
  return 0;
}
