...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_66f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_66(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3921U, 3922U };
  ...
  static size_t selector_X_[3] = { 2147U, 2155U, 2156U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_66xnplus1;
