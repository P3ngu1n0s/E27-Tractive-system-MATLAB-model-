...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_212f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_212(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 700U, 710U, 711U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_212xnplus1;
