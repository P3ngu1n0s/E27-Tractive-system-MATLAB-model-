...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_224f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_224(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4196U, 4197U };
  ...
  static size_t selector_X_[3] = { 584U, 594U, 595U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_224xnplus1;
