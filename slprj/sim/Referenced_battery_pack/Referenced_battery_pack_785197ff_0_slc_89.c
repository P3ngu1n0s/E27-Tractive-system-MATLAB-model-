...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_89f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_89(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3871U, 3872U };
  ...
  static size_t selector_X_[3] = { 1919U, 1929U, 1930U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_89xnplus1;
