...
int32_T Referenced_battery_pack_785197ff_0_slc_399jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    zc_int285 = 8.200000000000002E-8;
  } else {
    zc_int285 = t12[0UL];
  }

  out->mJNL.mX[0UL] = zc_int282;
  out->mJNL.mX[1UL] = -zc_int285;
  (void)sys;
  (void)out;
  return 0;
}
