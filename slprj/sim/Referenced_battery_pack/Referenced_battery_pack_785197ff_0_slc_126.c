...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_126f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_126(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3788U, 3789U };
  ...
  static size_t selector_X_[3] = { 1550U, 1557U, 1558U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_126xnplus1;
