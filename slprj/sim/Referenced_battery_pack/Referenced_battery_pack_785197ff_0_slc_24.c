...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_24f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_24(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 2569U, 2576U, 2577U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_24xnplus1;
