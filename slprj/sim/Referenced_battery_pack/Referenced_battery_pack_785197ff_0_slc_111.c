...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_111f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_111(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3821U, 3822U };
  ...
  static size_t selector_X_[3] = { 1694U, 1704U, 1705U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_111xnplus1;
