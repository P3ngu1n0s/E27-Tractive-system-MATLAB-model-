...
#include "Referenced_battery_pack_785197ff_0_slc_0_external_struct.h"
#include "Referenced_battery_pack_785197ff_0_slc_0_externals.h"
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_0(PmAllocator
  *allocator)
{
  static NeDynamicSystemInputSizes sizes = { { 0U, 0U, 1U, 0U, 0U, 1U, 0U, 0U,
  ...
  static size_t selector_X_[1] = { 2800U };

  static PmSizeVector selector_X = { 1U, selector_X_ };
  ...
  static int32_T state_indices_out_[1] = { 1 };

  static PmIntVector state_indices_out = { 1U, state_indices_out_ };
...
{
  (void)t1;
  out->mMCON_P.mNumCol = 1UL;
  out->mMCON_P.mNumRow = 1UL;
  out->mMCON_P.mJc[0] = 0;
  out->mMCON_P.mJc[1] = 0;
  (void)sys;
  (void)out;
...
{
  (void)t1;
  out->mMPAR_P.mNumCol = 1UL;
  out->mMPAR_P.mNumRow = 1UL;
  out->mMPAR_P.mJc[0] = 0;
  out->mMPAR_P.mJc[1] = 0;
  (void)sys;
  (void)out;
...
{
  (void)t1;
  out->mMNL_P.mNumCol = 1UL;
  out->mMNL_P.mNumRow = 1UL;
  out->mMNL_P.mJc[0] = 0;
  out->mMNL_P.mJc[1] = 0;
  (void)sys;
  (void)out;
...
{
  (void)t1;
  out->mJCON_P.mNumCol = 1UL;
  out->mJCON_P.mNumRow = 1UL;
  out->mJCON_P.mJc[0] = 0;
  out->mJCON_P.mJc[1] = 1;
  out->mJCON_P.mIr[0] = 0;
  (void)sys;
...
{
  (void)t1;
  out->mJPAR_P.mNumCol = 1UL;
  out->mJPAR_P.mNumRow = 1UL;
  out->mJPAR_P.mJc[0] = 0;
  out->mJPAR_P.mJc[1] = 0;
  (void)sys;
  (void)out;
...
{
  (void)t1;
  out->mJNL_P.mNumCol = 1UL;
  out->mJNL_P.mNumRow = 1UL;
  out->mJNL_P.mJc[0] = 0;
  out->mJNL_P.mJc[1] = 0;
  (void)sys;
  (void)out;
