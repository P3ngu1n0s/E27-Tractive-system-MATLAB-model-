...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_32f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_32(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3997U, 3998U };
  ...
  static size_t selector_X_[3] = { 2490U, 2500U, 2501U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_32xnplus1;
