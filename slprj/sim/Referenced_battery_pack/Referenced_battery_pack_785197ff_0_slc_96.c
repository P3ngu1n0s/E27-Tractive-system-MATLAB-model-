...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_96f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_96(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3854U, 3855U };
  ...
  static size_t selector_X_[3] = { 1854U, 1861U, 1862U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_96xnplus1;
