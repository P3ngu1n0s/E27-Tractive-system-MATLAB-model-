...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_277f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_277(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4106U, 4107U };
  ...
  static size_t selector_X_[3] = { 181U, 188U, 189U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_277xnplus1;
