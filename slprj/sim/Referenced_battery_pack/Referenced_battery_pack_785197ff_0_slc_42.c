...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_42f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_42(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3974U, 3975U };
  ...
  static size_t selector_X_[3] = { 2393U, 2401U, 2402U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_42xnplus1;
