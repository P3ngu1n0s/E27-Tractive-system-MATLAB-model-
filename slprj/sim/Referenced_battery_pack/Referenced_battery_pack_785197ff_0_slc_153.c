...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_153f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_153(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3728U, 3729U };
  ...
  static size_t selector_X_[3] = { 1283U, 1291U, 1292U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_153xnplus1;
