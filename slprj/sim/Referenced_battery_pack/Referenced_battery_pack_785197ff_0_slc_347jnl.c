...
int32_T Referenced_battery_pack_785197ff_0_slc_347jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t12[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    ...
    &t5[0UL]);
  if (t20->mM.mX[3UL] != 0) {
    zc_int405 = 8.200000000000002E-8;
  } else {
    zc_int405 = t19[0UL];
  }

  if (t20->mM.mX[5UL] != 0) {
    zc_int423 = 8.200000000000002E-8;
  } else {
    zc_int423 = t12[0UL];
  }

  out->mJNL.mX[0UL] = -zc_int423;
  out->mJNL.mX[1UL] = zc_int405;
  (void)sys;
  (void)out;
  return 0;
}
