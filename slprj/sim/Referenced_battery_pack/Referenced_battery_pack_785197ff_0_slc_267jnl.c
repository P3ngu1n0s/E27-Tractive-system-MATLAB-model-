...
#include "Referenced_battery_pack_785197ff_0_slc_267jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_267jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[3UL] != 0) {
    ...
    Accumalator_Module_Five1_Battery_Table_Based40_stateOfCharge = t19[0UL];
  }

  out->mJNL.mX[0UL] = -zc_int102;
  out->mJNL.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based40_stateOfCharge;
  (void)sys;
  (void)out;
