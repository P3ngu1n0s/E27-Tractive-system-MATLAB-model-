...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_399jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_399fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_399(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 241U, 242U, 979U, 990U, 1002U, 1013U };
  ...
  static size_t selector_X_[15] = { 920U, 930U, 950U, 951U, 953U, 954U, 955U,
    956U, 957U, 960U, 962U, 963U, 964U, 965U, 966U };
