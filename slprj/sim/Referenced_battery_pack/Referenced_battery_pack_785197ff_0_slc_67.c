...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_67f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_67(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3919U, 3920U };
  ...
  static size_t selector_X_[3] = { 2138U, 2145U, 2146U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_67xnplus1;
