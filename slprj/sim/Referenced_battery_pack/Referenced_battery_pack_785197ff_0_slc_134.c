...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_134f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_134(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3771U, 3772U };
  ...
  static size_t selector_X_[3] = { 1468U, 1475U, 1476U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_134xnplus1;
