...
int32_T Referenced_battery_pack_785197ff_0_slc_401jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    zc_int297 = 8.200000000000002E-8;
  } else {
    zc_int297 = t12[0UL];
  }

  out->mJNL.mX[0UL] = zc_int279;
  out->mJNL.mX[1UL] = -zc_int297;
  (void)sys;
  (void)out;
  return 0;
}
