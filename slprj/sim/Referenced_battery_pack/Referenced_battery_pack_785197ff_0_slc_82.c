...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_82f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_82(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3886U, 3887U };
  ...
  static size_t selector_X_[3] = { 1990U, 1999U, 2000U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_82xnplus1;
