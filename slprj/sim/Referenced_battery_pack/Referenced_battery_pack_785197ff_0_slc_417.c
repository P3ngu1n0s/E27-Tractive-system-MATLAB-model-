...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_417jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_417fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_417(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 235U, 257U, 868U, 879U, 1313U, 1324U };
  ...
  static size_t selector_X_[15] = { 562U, 576U, 897U, 898U, 900U, 901U, 902U,
    903U, 904U, 1094U, 1096U, 1097U, 1098U, 1099U, 1100U };
