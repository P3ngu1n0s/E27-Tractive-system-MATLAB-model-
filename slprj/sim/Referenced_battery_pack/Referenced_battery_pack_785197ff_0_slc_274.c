...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_274f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_274(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4110U, 4111U };
  ...
  static size_t selector_X_[3] = { 201U, 208U, 209U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_274xnplus1;
