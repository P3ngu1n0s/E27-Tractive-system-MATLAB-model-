...
#include "Referenced_battery_pack_785197ff_0_slc_236jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_236jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t19[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    ...
    &t5[0UL]);
  t12[0UL] = t20->mX.mX[8UL] * 5.5555555555555558E-5;
  tlu2_linear_nearest_prelookup(&t2.mField0[0UL], &t2.mField1[0UL], &t2.mField2
    [0UL], &nonscalar1[0UL], &t12[0UL], &t4[0UL], &t5[0UL]);
  ...
  if (t20->mM.mX[1UL] != 0) {
    ...
    intrm_sf_mf_47 = t12[0UL];
  }

  out->mJNL.mX[0UL] = -intrm_sf_mf_47;
  out->mJNL.mX[1UL] = zc_int141;
  (void)sys;
  (void)out;
  return 0;
}
