...
int32_T Referenced_battery_pack_785197ff_0_slc_179fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int307 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int307 = t25[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based54_stateOfCharge = nonscalar0[t4
      [0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  }

  out->mFX.mX[0UL] = t42->mX.mX[7UL] - ((((((t42->mX.mX[1UL] *
    Accumalator_Module_One1_Battery_Table_Based51_stateOfCharge + t42->mX.mX[9UL])
    + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) + t42->mX.mX[12UL]) + t42->mX.mX
    [13UL]) + Accumalator_Module_One1_Battery_Table_Based54_stateOfCharge);
  out->mFX.mX[1UL] = t42->mX.mX[7UL] - (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL])
    * zc_int306 + t42->mX.mX[2UL]) + t42->mX.mX[3UL]) + t42->mX.mX[4UL]) +
    t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + zc_int307);
  (void)sys;
  (void)out;
  return 0;
}
