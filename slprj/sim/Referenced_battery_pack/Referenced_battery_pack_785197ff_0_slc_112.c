...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_112f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_112(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3819U, 3820U };
  ...
  static size_t selector_X_[3] = { 1682U, 1692U, 1693U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_112xnplus1;
