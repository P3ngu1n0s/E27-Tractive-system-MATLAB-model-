...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_261f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_261(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4130U, 4131U };
  ...
  static size_t selector_X_[3] = { 290U, 297U, 298U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_261xnplus1;
