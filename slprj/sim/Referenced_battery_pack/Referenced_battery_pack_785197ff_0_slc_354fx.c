...
int32_T Referenced_battery_pack_785197ff_0_slc_354fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int376 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int376 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based21_electricalModel_v -
    ((((((t42->mX.mX[1UL] * zc_int393 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
        t42->mX.mX[12UL]) + t42->mX.mX[13UL]) + t42->mX.mX[14UL]) +
     Accumalator_Module_Three1_Battery_Table_Based27_stateOfCharge);
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based21_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int375 + t42->mX.mX[4UL]) +
