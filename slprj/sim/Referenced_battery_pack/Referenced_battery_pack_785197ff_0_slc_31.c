...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_31f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_31(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3999U, 4000U };
  ...
  static size_t selector_X_[3] = { 2502U, 2509U, 2510U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_31xnplus1;
