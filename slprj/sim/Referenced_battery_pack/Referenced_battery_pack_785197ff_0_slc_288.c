...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_288f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_288(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4091U, 4092U };
  ...
  static size_t selector_X_[3] = { 109U, 116U, 117U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_288xnplus1;
