...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_85f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_85(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3880U, 3881U };
  ...
  static size_t selector_X_[3] = { 1962U, 1970U, 1971U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_85xnplus1;
