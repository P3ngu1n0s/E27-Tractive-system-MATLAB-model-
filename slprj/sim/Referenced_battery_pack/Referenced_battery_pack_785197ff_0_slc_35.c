...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_35f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_35(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3991U, 3992U };
  ...
  static size_t selector_X_[3] = { 2460U, 2467U, 2468U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_35xnplus1;
