...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_246f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_246(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4152U, 4153U };
  ...
  static size_t selector_X_[3] = { 390U, 398U, 399U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_246xnplus1;
