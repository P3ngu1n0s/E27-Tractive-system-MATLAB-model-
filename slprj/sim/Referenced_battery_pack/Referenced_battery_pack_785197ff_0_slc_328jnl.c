...
#include "Referenced_battery_pack_785197ff_0_slc_328jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_328jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_four_Battery_Table_Based16_stateOfCharge = t12[0UL];
  }

  out->mJNL.mX[0UL] = zc_int693;
  out->mJNL.mX[1UL] =
    -Accumalator_Module_four_Battery_Table_Based16_stateOfCharge;
  (void)sys;
  (void)out;
