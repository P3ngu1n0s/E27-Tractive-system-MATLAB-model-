...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_131f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_131(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3777U, 3778U };
  ...
  static size_t selector_X_[3] = { 1501U, 1509U, 1510U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_131xnplus1;
