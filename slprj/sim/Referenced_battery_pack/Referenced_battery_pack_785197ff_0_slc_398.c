...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_398jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_398fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_398(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 238U, 243U, 913U, 924U, 1024U, 1035U };
  ...
  static size_t selector_X_[15] = { 916U, 917U, 918U, 920U, 921U, 922U, 923U,
    924U, 925U, 969U, 971U, 972U, 973U, 974U, 975U };
