...
int32_T Referenced_battery_pack_785197ff_0_slc_344fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_Three1_Battery_Table_Based48_electricalModel_xVint;
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_148 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_148 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based42_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int444 + t42->mX.mX[4UL]) +
