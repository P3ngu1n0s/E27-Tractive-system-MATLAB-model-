...
int32_T Referenced_battery_pack_785197ff_0_slc_350fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_Three1_Battery_Table_Based39_electricalModel_xVint;
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_138 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_138 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based33_electricalModel_v -
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int414 + t42->mX.mX[4UL]) +
