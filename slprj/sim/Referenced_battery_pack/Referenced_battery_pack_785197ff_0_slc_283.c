...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_283jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_283fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_283(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 156U, 160U, 2890U, 3001U, 3557U, 3568U };
  ...
  static size_t selector_X_[15] = { 130U, 190U, 191U, 192U, 194U, 195U, 196U,
    197U, 198U, 219U, 221U, 222U, 223U, 224U, 225U };
