...
int32_T Referenced_battery_pack_785197ff_0_slc_359fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_Three1_Battery_Table_Based9_electricalModel_xVint;
  real_T zc_int360;
  real_T zc_int361;
  real_T zc_int501;
  size_t t4[1];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_Three1_Battery_Table_Based9_electricalModel_xVint = t27[0UL];
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int361 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int361 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based17_electricalModel_v -
    ((((((t42->mX.mX[3UL] * zc_int501 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
        t42->mX.mX[12UL]) + t42->mX.mX[13UL]) + t42->mX.mX[14UL]) +
     Accumalator_Module_Three1_Battery_Table_Based9_electricalModel_xVint);
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based17_electricalModel_v -
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int360 + t42->mX.mX[4UL]) +
