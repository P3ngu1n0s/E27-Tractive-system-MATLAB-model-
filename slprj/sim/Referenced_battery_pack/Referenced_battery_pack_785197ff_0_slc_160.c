...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_160f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_160(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3713U, 3714U };
  ...
  static size_t selector_X_[3] = { 1211U, 1219U, 1220U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_160xnplus1;
