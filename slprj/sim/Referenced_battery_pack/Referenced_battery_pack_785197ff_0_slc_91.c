...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_91f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_91(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3865U, 3866U };
  ...
  static size_t selector_X_[3] = { 1901U, 1908U, 1909U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_91xnplus1;
