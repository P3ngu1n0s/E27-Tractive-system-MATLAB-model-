...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_76f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_76(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3899U, 3900U };
  ...
  static size_t selector_X_[3] = { 2050U, 2060U, 2061U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_76xnplus1;
