...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_142f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_142(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3752U, 3753U };
  ...
  static size_t selector_X_[3] = { 1391U, 1399U, 1400U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_142xnplus1;
