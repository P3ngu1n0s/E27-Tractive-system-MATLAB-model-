...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_171f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_171(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1094U, 1101U, 1102U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_171xnplus1;
