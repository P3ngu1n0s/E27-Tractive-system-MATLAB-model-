...
int32_T Referenced_battery_pack_785197ff_0_slc_330fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_four_Battery_Table_Based14_electricalModel_xVint;
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_four_Battery_Table_Based11_electricalModel_v = -t42->mX.mX
    [2UL] + t42->mX.mX[3UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_four_Battery_Table_Based14_electricalModel_xVint = t27[0UL];
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_226 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_226 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_four_Battery_Table_Based11_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int678 + t42->mX.mX[4UL]) +
