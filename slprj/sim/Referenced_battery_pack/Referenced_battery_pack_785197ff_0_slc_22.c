...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_22f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_22(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4019U, 4020U };
  ...
  static size_t selector_X_[3] = { 2588U, 2595U, 2596U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_22xnplus1;
