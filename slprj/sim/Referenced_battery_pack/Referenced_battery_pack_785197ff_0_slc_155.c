...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_155f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_155(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3724U, 3725U };
  ...
  static size_t selector_X_[3] = { 1261U, 1271U, 1272U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_155xnplus1;
