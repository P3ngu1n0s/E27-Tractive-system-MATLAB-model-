...
int32_T Referenced_battery_pack_785197ff_0_slc_110xnplus1(const
  SwitchedLinearClump *sys, const NeDynamicSystemInput *t33, SlcMethodOutput
  *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t7[0UL], &t0.mField0[0UL], &t0.mField2[0UL],
    &t1.mField0[0UL], &t1.mField2[0UL], &nonscalar7[0UL], &t20[0UL], &t8[0UL],
    &t6[0UL]);
  Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge = t7[0UL];
  ...
  if (t33->mM.mX[0UL] != 0) {
    ...
    Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge = nonscalar9[t20
      [0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  if (t33->mM.mX[1UL] != 0) {
    ...
    t3 = nonscalar9[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  } else {
    t3 = t7[0UL];
  }

  Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge = -(1.0 /
    (Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge == 0.0 ? 1.0E-16
     : Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge));
  out->mXNPLUS1.mX[0UL] =
    -Accumalator_Module_Two_Battery_Table_Based11_stateOfCharge;
  out->mXNPLUS1.mX[1UL] = 1.0 / (t3 == 0.0 ? 1.0E-16 : t3);
  (void)sys;
  (void)out;
  return 0;
}
