...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_299jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_299fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_299(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 91U, 102U, 143U, 196U, 224U, 335U };
  ...
  static size_t selector_X_[15] = { 26U, 68U, 69U, 70U, 72U, 73U, 74U, 75U, 76U,
    542U, 544U, 545U, 546U, 547U, 548U };
  ...
  static int32_T state_indices_[2] = { 0, 2 };
