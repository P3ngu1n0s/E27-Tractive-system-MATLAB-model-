...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_33f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_33(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3995U, 3996U };
  ...
  static size_t selector_X_[3] = { 2478U, 2488U, 2489U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_33xnplus1;
