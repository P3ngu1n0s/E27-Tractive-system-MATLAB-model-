...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_289f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_289(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4087U, 4088U };
  ...
  static size_t selector_X_[3] = { 100U, 107U, 108U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_289xnplus1;
