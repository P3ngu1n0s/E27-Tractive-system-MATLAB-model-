...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_143f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_143(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1382U, 1389U, 1390U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_143xnplus1;
