...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_282f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_282(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4095U, 4096U };
  ...
  static size_t selector_X_[3] = { 128U, 138U, 139U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_282xnplus1;
