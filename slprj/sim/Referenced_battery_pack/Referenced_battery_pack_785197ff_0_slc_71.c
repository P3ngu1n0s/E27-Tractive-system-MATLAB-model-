...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_71f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_71(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3910U, 3911U };
  ...
  static size_t selector_X_[3] = { 2100U, 2109U, 2110U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_71xnplus1;
