...
int32_T Referenced_battery_pack_785197ff_0_slc_357fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_Three1_Battery_Table_Based8_electricalModel_xVint = t27[0UL];
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int355 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int355 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based15_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int354 + t42->mX.mX[4UL]) +
