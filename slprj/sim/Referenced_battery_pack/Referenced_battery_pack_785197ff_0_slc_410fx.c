...
int32_T Referenced_battery_pack_785197ff_0_slc_410fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_One1_Battery_Table_Based21_electricalModel_v = -t42->mX.mX
    [2UL] + t42->mX.mX[3UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_One1_Battery_Table_Based27_electricalModel_xVint = t27[0UL];
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int208 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int208 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_One1_Battery_Table_Based21_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int207 + t42->mX.mX[4UL]) +
