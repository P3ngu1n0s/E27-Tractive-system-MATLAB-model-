...
int32_T Referenced_battery_pack_785197ff_0_slc_356fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int358 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int358 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based16_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int357 + t42->mX.mX[4UL]) +
