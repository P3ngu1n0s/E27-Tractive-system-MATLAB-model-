...
int32_T Referenced_battery_pack_785197ff_0_slc_243fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_Five1_Battery_Table_Based53_electricalModel_xVint;
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    zc_int145 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int145 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based53_electricalModel_v -
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int144 + t42->mX.mX[4UL]) +
