...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_107f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_107(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3830U, 3831U };
  ...
  static size_t selector_X_[3] = { 1741U, 1748U, 1749U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_107xnplus1;
