...
int32_T Referenced_battery_pack_785197ff_0_slc_412fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_One1_Battery_Table_Based16_electricalModel_xVint;
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_One1_Battery_Table_Based16_electricalModel_v = -t42->mX.mX
    [3UL] + t42->mX.mX[0UL];
  t27[0UL] = t42->mX.mX[1UL] * 5.5555555555555558E-5;
  ...
  tlu2_2d_linear_nearest_value(&t25[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  t27[0UL] = t42->mX.mX[9UL] * 5.5555555555555558E-5;
  tlu2_linear_nearest_prelookup(&t1.mField0[0UL], &t1.mField1[0UL], &t1.mField2
    [0UL], &nonscalar1[0UL], &t27[0UL], &t4[0UL], &t5[0UL]);
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_One1_Battery_Table_Based19_stateOfCharge = t27[0UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  intrm_sf_mf_63 = t27[0UL];
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  if (t42->mM.mX[3UL] != 0) {
    zc_int189 = 8.200000000000002E-8;
  } else {
    zc_int189 = intrm_sf_mf_63;
  }
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_63 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_63 = t25[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based19_stateOfCharge = nonscalar0[t4
      [0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  }
  ...
  out->mFX.mX[0UL] =
    ...
    ((((((t42->mX.mX[2UL] *
          Accumalator_Module_One1_Battery_Table_Based16_electricalModel_xVint
          + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) + t42->mX.mX[12UL]) +
       t42->mX.mX[13UL]) + t42->mX.mX[14UL]) +
     Accumalator_Module_One1_Battery_Table_Based19_stateOfCharge);
  out->mFX.mX[1UL] =
    Accumalator_Module_One1_Battery_Table_Based16_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int189 + t42->mX.mX[4UL]) +
