...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_72f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_72(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3908U, 3909U };
  ...
  static size_t selector_X_[3] = { 2091U, 2098U, 2099U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_72xnplus1;
