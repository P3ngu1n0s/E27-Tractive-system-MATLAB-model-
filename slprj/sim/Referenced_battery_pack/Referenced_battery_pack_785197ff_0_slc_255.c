...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_255f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_255(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4141U, 4142U };
  ...
  static size_t selector_X_[3] = { 337U, 345U, 346U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_255xnplus1;
