...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_211f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_211(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 712U, 720U, 721U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_211xnplus1;
