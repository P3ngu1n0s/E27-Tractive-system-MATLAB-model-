...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_419jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_419fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_419(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 210U, 222U, 380U, 391U, 624U, 635U };
  ...
  static size_t selector_X_[15] = { 564U, 598U, 678U, 679U, 681U, 682U, 683U,
    684U, 685U, 788U, 790U, 791U, 792U, 793U, 794U };
