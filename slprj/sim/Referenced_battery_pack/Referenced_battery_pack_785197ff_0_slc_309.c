...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_309jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_309fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_309(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 47U, 58U, 141U, 194U, 3978U, 4089U };
  ...
  static size_t selector_X_[15] = { 40U, 48U, 49U, 51U, 52U, 53U, 54U, 55U, 56U,
    524U, 526U, 527U, 528U, 529U, 530U };
  ...
  static int32_T state_indices_[2] = { 2, 3 };
...
static int32_T slc_mode (const SwitchedLinearClump *sys, const
  NeDynamicSystemInput *t1, SlcMethodOutput *out)
{
  out->mMODE.mX[0UL] = (int32_T)(-t1->mX.mX[2UL] - t1->mU.mX[0UL] < 0.0);
  out->mMODE.mX[1UL] = (int32_T)(t1->mX.mX[2UL] < 0.0);
  (void)sys;
  (void)out;
  return 0;
}
