...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_124f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_124(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1568U, 1575U, 1576U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_124xnplus1;
...
{
  out->mFX.mX[0UL] = t1->mX.mX[1UL];
  out->mFX.mX[1UL] = t1->mX.mX[2UL];
  (void)sys;
  (void)out;
  return 0;
}
