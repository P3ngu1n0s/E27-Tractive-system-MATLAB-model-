...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_139f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_139(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3760U, 3761U };
  ...
  static size_t selector_X_[3] = { 1420U, 1427U, 1428U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_139xnplus1;
