...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_290f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_290(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4085U, 4086U };
  ...
  static size_t selector_X_[3] = { 90U, 98U, 99U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_290xnplus1;
