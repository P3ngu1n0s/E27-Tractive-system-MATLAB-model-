...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_57f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_57(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3941U, 3942U };
  ...
  static size_t selector_X_[3] = { 2232U, 2239U, 2240U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_57xnplus1;
