...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_204f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_204(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 779U, 786U, 787U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_204xnplus1;
