...
#include "Referenced_battery_pack_785197ff_0_slc_357jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_357jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  size_t t5[1];
  size_t t7[1];
  t12[0UL] = t20->mX.mX[1UL] * 5.5555555555555558E-5;
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_Three1_Battery_Table_Based15_stateOfCharge = t12[0UL];
  }

  out->mJNL.mX[0UL] = zc_int354;
  out->mJNL.mX[1UL] =
    -Accumalator_Module_Three1_Battery_Table_Based15_stateOfCharge;
  (void)sys;
  (void)out;
