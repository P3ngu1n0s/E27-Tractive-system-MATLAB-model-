...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_88f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_88(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3873U, 3874U };
  ...
  static size_t selector_X_[3] = { 1931U, 1941U, 1942U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_88xnplus1;
