...
int32_T Referenced_battery_pack_785197ff_0_slc_299fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    ...
    &t5[0UL]);
  if (t42->mM.mX[1UL] != 0) {
    zc_int162 = 8.200000000000002E-8;
  } else {
    zc_int162 = zc_int163;
  }
  ...
  if (t42->mM.mX[0UL] != 0) {
    ...
    zc_int163 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int163 = zc_int18;
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    intrm_sf_mf_6 = t25[0UL];
  }

  out->mFX.mX[0UL] =
    Accumalator_Module_Five1_Battery_Table_Based15_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int18 + t42->mX.mX[4UL]) +
         t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX[7UL]) + t42->mX.mX[8UL])
     + intrm_sf_mf_6);
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based15_electricalModel_v -
    ((((((t42->mX.mX[2UL] * zc_int162 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
        t42->mX.mX[12UL]) + t42->mX.mX[13UL]) + t42->mX.mX[14UL]) + zc_int163);
  (void)sys;
  (void)out;
  return 0;
}
