...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_296f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_296(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4076U, 4077U };
  ...
  static size_t selector_X_[3] = { 48U, 57U, 58U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_296xnplus1;
