...
int32_T Referenced_battery_pack_785197ff_0_slc_378fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_Two_Battery_Table_Based33_electricalModel_v = -t42->mX.mX
    [1UL] + t42->mX.mX[0UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_Two_Battery_Table_Based39_stateOfCharge = t27[0UL];
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int583 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int583 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    ...
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int582 + t42->mX.mX[4UL]) +
         t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX[7UL]) + t42->mX.mX[8UL])
     + zc_int583);
  out->mFX.mX[1UL] =
    Accumalator_Module_Two_Battery_Table_Based33_electricalModel_v -
    ((((((t42->mX.mX[3UL] * zc_int600 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
