...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_222jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_222fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_222(PmAllocator
  *allocator)
{
  static NeDynamicSystemInputSizes sizes = { { 0U, 6U, 1U, 1U, 0U, 14U, 0U, 0U,
      0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, } };

  static PmSizeVector selector_Q = { 0U, NULL };

  static size_t selector_M_[6] = { 203U, 225U, 236U, 256U, 1291U, 1302U };
  ...
  static size_t selector_X_[14] = { 608U, 609U, 612U, 613U, 614U, 615U, 616U,
    611U, 1085U, 1087U, 1088U, 1089U, 1090U, 1091U };

  static PmSizeVector selector_X = { 14U, selector_X_ };
  ...
  static int32_T state_indices_[2] = { 1, 7 };
  ...
  static int32_T mode_indices_[2] = { 0, 3 };

  static PmIntVector mode_indices = { 2U, mode_indices_ };

  static int32_T m_ref_indices_[4] = { 1, 2, 4, 5 };
...
static int32_T slc_mode (const SwitchedLinearClump *sys, const
  NeDynamicSystemInput *t1, SlcMethodOutput *out)
{
  out->mMODE.mX[0UL] = (int32_T)(-t1->mX.mX[1UL] - t1->mU.mX[0UL] < 0.0);
  out->mMODE.mX[1UL] = (int32_T)(t1->mX.mX[1UL] < 0.0);
  (void)sys;
  (void)out;
  return 0;
}
