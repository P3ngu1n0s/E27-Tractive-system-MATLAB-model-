...
int32_T Referenced_battery_pack_785197ff_0_slc_389jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  size_t t5[1];
  size_t t7[1];
  t12[0UL] = t20->mX.mX[2UL] * 5.5555555555555558E-5;
  ...
  tlu2_linear_nearest_prelookup(&t2.mField0[0UL], &t2.mField1[0UL], &t2.mField2
    [0UL], &nonscalar1[0UL], &t12[0UL], &t4[0UL], &t5[0UL]);
  t12[0] = 298.15;
  t7[0] = 4UL;
  tlu2_linear_nearest_prelookup(&t0.mField0[0UL], &t0.mField1[0UL], &t0.mField2
    [0UL], &nonscalar2[0UL], &t12[0UL], &t7[0UL], &t5[0UL]);
  tlu2_2d_linear_nearest_value(&t19[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  t12[0UL] = t20->mX.mX[9UL] * 5.5555555555555558E-5;
  tlu2_linear_nearest_prelookup(&t2.mField0[0UL], &t2.mField1[0UL], &t2.mField2
    [0UL], &nonscalar1[0UL], &t12[0UL], &t4[0UL], &t5[0UL]);
  tlu2_2d_linear_nearest_value(&t12[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  if (t20->mM.mX[3UL] != 0) {
  ...
  out->mJNL.mX[0UL] = zc_int603;
  out->mJNL.mX[1UL] = -Accumalator_Module_Two_Battery_Table_Based4_stateOfCharge;
  (void)sys;
  (void)out;
  return 0;
}
