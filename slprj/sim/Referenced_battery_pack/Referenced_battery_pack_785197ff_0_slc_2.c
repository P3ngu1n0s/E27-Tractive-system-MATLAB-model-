...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_2f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_2(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4063U, 4064U };
  ...
  static size_t selector_X_[3] = { 2782U, 2789U, 2790U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_2xnplus1;
