...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_38f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_38(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3984U, 3985U };
  ...
  static size_t selector_X_[3] = { 2431U, 2440U, 2441U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_38xnplus1;
