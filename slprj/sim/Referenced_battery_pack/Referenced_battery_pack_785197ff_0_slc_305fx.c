...
int32_T Referenced_battery_pack_785197ff_0_slc_305fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_Five1_Battery_Table_Based4_electricalModel_xVint;
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_Five1_Battery_Table_Based4_electricalModel_v = -t42->mX.mX
    [1UL] + t42->mX.mX[0UL];
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    zc_int100 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int100 = t25[0UL];
  }
  ...
  if (t42->mM.mX[0UL] != 0) {
    ...
    zc_int160 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int160 = zc_int99;
  }
  ...
  out->mFX.mX[0UL] =
    ...
    ((((((t42->mX.mX[3UL] *
       ...
       t42->mX.mX[13UL]) + t42->mX.mX[14UL]) + zc_int160);
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based4_electricalModel_v -
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int99 + t42->mX.mX[4UL]) +
