...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_154f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_154(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3726U, 3727U };
  ...
  static size_t selector_X_[3] = { 1273U, 1281U, 1282U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_154xnplus1;
