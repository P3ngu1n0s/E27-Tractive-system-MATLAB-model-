...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_250jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_250fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_250(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 182U, 186U, 4001U, 4012U, 4090U, 4101U };
  ...
  static size_t selector_X_[15] = { 358U, 418U, 419U, 420U, 422U, 423U, 424U,
    425U, 426U, 456U, 458U, 459U, 460U, 461U, 462U };
