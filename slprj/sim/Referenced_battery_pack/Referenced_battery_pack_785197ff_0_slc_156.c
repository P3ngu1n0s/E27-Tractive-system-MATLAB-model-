...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_156f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_156(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3721U, 3722U };
  ...
  static size_t selector_X_[3] = { 1249U, 1259U, 1260U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_156xnplus1;
