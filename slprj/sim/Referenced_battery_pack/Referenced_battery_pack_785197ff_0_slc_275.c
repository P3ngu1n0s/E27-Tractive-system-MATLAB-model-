...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_275f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_275(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4108U, 4109U };
  ...
  static size_t selector_X_[3] = { 190U, 199U, 200U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_275xnplus1;
