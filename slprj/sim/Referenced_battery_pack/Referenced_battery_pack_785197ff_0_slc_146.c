...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_146f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_146(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3743U, 3744U };
  ...
  static size_t selector_X_[3] = { 1349U, 1356U, 1357U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_146xnplus1;
