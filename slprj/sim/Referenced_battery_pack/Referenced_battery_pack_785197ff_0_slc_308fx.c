...
int32_T Referenced_battery_pack_785197ff_0_slc_308fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int10 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int10 = t25[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    zc_int133 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
  ...
  out->mFX.mX[0UL] =
    ...
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) *
          Accumalator_Module_Five1_Battery_Table_Based5_stateOfCharge +
          t42->mX.mX[4UL]) + t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX
       [7UL]) + t42->mX.mX[8UL]) + zc_int10);
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based12_electricalModel_v -
    ((((((t42->mX.mX[1UL] * zc_int132 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
        t42->mX.mX[12UL]) + t42->mX.mX[13UL]) + t42->mX.mX[14UL]) + zc_int133);
  (void)sys;
  (void)out;
  return 0;
}
