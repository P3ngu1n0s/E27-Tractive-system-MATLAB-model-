...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_412jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_412fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_412(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 206U, 209U, 291U, 302U, 358U, 369U };
  ...
  static size_t selector_X_[15] = { 630U, 639U, 640U, 641U, 643U, 644U, 645U,
    646U, 647U, 669U, 671U, 672U, 673U, 674U, 675U };
