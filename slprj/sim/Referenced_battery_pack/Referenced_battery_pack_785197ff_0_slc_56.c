...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_56f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_56(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3943U, 3944U };
  ...
  static size_t selector_X_[3] = { 2241U, 2251U, 2252U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_56xnplus1;
