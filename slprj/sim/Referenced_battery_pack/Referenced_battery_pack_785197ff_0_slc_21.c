...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_21f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_21(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4021U, 4022U };
  ...
  static size_t selector_X_[3] = { 2597U, 2607U, 2608U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_21xnplus1;
