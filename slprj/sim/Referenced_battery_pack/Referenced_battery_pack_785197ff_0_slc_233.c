...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_233f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_233(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4176U, 4177U };
  ...
  static size_t selector_X_[3] = { 497U, 504U, 505U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_233xnplus1;
