...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_169f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_169(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1112U, 1119U, 1120U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_169xnplus1;
