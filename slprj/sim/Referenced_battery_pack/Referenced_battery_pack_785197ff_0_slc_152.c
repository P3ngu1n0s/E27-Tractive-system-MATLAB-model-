...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_152f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_152(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3730U, 3731U };
  ...
  static size_t selector_X_[3] = { 1293U, 1300U, 1301U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_152xnplus1;
