...
int32_T Referenced_battery_pack_785197ff_0_slc_250fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    intrm_sf_mf_41 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_41 = t25[0UL];
  }
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based47_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int123 + t42->mX.mX[4UL]) +
