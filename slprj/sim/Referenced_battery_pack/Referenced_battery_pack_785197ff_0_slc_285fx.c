...
int32_T Referenced_battery_pack_785197ff_0_slc_285fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int46 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int46 = t25[0UL];
  }

  if (t42->mM.mX[5UL] != 0) {
    zc_int48 = 8.200000000000002E-8;
  } else {
    zc_int48 = t27[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    ...
    (((((((-t42->mX.mX[3UL] - t42->mU.mX[0UL]) * zc_int45 + t42->mX.mX[4UL]) +
         t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX[7UL]) + t42->mX.mX[8UL])
     + zc_int46);
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based23_electricalModel_v -
    ((((((t42->mX.mX[3UL] * zc_int48 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
