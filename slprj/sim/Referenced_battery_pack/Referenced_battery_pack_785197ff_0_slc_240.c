...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_240f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_240(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4163U, 4164U };
  ...
  static size_t selector_X_[3] = { 438U, 445U, 446U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_240xnplus1;
