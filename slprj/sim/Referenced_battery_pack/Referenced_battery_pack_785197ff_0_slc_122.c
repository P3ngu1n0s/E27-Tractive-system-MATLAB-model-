...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_122f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_122(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3797U, 3798U };
  ...
  static size_t selector_X_[3] = { 1586U, 1595U, 1596U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_122xnplus1;
