...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_239f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_239(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4165U, 4166U };
  ...
  static size_t selector_X_[3] = { 447U, 454U, 455U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_239xnplus1;
