...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_41f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_41(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3976U, 3977U };
  ...
  static size_t selector_X_[3] = { 2403U, 2411U, 2412U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_41xnplus1;
