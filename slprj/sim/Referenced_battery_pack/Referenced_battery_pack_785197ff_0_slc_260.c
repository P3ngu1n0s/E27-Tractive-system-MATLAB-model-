...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_260f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_260(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4132U, 4133U };
  ...
  static size_t selector_X_[3] = { 299U, 306U, 307U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_260xnplus1;
