...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_133f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_133(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3773U, 3774U };
  ...
  static size_t selector_X_[3] = { 1477U, 1487U, 1488U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_133xnplus1;
