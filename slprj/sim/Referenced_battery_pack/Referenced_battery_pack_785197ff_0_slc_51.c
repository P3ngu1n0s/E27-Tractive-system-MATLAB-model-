...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_51f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_51(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3954U, 3955U };
  ...
  static size_t selector_X_[3] = { 2300U, 2307U, 2308U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_51xnplus1;
