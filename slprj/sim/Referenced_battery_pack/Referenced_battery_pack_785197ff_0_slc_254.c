...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_254f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_254(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4143U, 4144U };
  ...
  static size_t selector_X_[3] = { 347U, 354U, 355U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_254xnplus1;
