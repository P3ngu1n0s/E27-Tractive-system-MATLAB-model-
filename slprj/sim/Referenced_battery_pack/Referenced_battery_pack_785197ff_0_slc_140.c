...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_140f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_140(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3758U, 3759U };
  ...
  static size_t selector_X_[3] = { 1411U, 1418U, 1419U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_140xnplus1;
