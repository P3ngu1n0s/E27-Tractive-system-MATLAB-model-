...
int32_T Referenced_battery_pack_785197ff_0_slc_300fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_Five1_Battery_Table_Based11_electricalModel_v = -t42->
  ...
  out->mFX.mX[0UL] =
    ...
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int6 + t42->mX.mX[4UL]) +
         t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX[7UL]) + t42->mX.mX[8UL])
     + zc_int7);
  out->mFX.mX[1UL] =
    Accumalator_Module_Five1_Battery_Table_Based11_electricalModel_v -
    ((((((t42->mX.mX[1UL] * zc_int15 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
