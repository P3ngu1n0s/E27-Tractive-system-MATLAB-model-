...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_83f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_83(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3884U, 3885U };
  ...
  static size_t selector_X_[3] = { 1981U, 1988U, 1989U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_83xnplus1;
