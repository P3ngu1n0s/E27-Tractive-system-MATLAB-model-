...
int32_T Referenced_battery_pack_785197ff_0_slc_342fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    ...
    &t5[0UL]);
  if (t42->mM.mX[3UL] != 0) {
    zc_int441 = 8.200000000000002E-8;
  } else {
    zc_int441 = zc_int442;
  }
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int442 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int442 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based41_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int441 + t42->mX.mX[4UL]) +
