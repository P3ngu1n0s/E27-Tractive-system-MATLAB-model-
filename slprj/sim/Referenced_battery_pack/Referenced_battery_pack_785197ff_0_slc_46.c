...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_46f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_46(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3965U, 3966U };
  ...
  static size_t selector_X_[3] = { 2350U, 2357U, 2358U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_46xnplus1;
