...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_7f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_7(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4052U, 4053U };
  ...
  static size_t selector_X_[3] = { 2737U, 2744U, 2745U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_7xnplus1;
