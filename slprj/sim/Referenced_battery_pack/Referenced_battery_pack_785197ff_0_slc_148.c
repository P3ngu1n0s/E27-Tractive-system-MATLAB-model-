...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_148f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_148(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1331U, 1338U, 1339U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_148xnplus1;
