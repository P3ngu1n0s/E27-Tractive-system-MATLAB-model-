...
int32_T Referenced_battery_pack_785197ff_0_slc_356jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    intrm_sf_mf_119 = t12[0UL];
  }

  out->mJNL.mX[0UL] = zc_int357;
  out->mJNL.mX[1UL] = -intrm_sf_mf_119;
  (void)sys;
  (void)out;
  return 0;
}
