...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_294jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_294fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_294(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 144U, 148U, 446U, 557U, 1113U, 1224U };
  ...
  static size_t selector_X_[15] = { 70U, 79U, 80U, 81U, 83U, 84U, 85U, 86U, 87U,
    109U, 111U, 112U, 113U, 114U, 115U };
