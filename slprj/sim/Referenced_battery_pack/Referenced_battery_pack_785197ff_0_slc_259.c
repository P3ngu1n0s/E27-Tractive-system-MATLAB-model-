...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_259jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_259fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_259(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 177U, 184U, 3912U, 3923U, 4045U, 4056U };
  ...
  static size_t selector_X_[15] = { 310U, 372U, 380U, 381U, 383U, 384U, 385U,
    386U, 387U, 438U, 440U, 441U, 442U, 443U, 444U };
