...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_12f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_12(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4041U, 4042U };
  ...
  static size_t selector_X_[3] = { 2688U, 2695U, 2696U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_12xnplus1;
