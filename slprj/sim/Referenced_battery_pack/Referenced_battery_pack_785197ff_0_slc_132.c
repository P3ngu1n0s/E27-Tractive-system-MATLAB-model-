...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_132f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_132(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3775U, 3776U };
  ...
  static size_t selector_X_[3] = { 1489U, 1499U, 1500U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_132xnplus1;
