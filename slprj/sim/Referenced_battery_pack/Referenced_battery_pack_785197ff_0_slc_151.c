...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_151f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_151(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3732U, 3733U };
  ...
  static size_t selector_X_[3] = { 1302U, 1309U, 1310U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_151xnplus1;
