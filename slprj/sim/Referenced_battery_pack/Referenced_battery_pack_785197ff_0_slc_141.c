...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_141f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_141(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3754U, 3755U };
  ...
  static size_t selector_X_[3] = { 1401U, 1409U, 1410U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_141xnplus1;
