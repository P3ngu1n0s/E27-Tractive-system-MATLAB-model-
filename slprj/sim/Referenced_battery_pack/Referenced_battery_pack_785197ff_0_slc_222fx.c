...
int32_T Referenced_battery_pack_785197ff_0_slc_222fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t25[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    ...
    &t5[0UL]);
  t27[0UL] = t42->mX.mX[8UL] * 5.5555555555555558E-5;
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_One1_Battery_Table_Based6_stateOfCharge = t27[0UL];
  ...
  if (t42->mM.mX[1UL] != 0) {
    ...
    zc_int181 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int181 = t25[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    intrm_sf_mf_108 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_108 = Accumalator_Module_One1_Battery_Table_Based6_stateOfCharge;
  }

  out->mFX.mX[0UL] = t42->mX.mX[7UL] - (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL])
    * zc_int180 + t42->mX.mX[2UL]) + t42->mX.mX[3UL]) + t42->mX.mX[4UL]) +
    t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + zc_int181);
  out->mFX.mX[1UL] = t42->mX.mX[7UL] - ((((((t42->mX.mX[1UL] * zc_int324 +
    t42->mX.mX[9UL]) + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) + t42->mX.mX[12UL])
    + t42->mX.mX[13UL]) + intrm_sf_mf_108);
  (void)sys;
  (void)out;
  return 0;
}
