...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_138f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_138(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3762U, 3763U };
  ...
  static size_t selector_X_[3] = { 1429U, 1438U, 1439U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_138xnplus1;
