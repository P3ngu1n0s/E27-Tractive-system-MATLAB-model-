...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_265f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_265(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4121U, 4122U };
  ...
  static size_t selector_X_[3] = { 249U, 259U, 260U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_265xnplus1;
