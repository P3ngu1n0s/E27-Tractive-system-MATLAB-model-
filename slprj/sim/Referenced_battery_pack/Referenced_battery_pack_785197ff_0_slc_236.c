...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_236jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_236fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_236(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 3U, 14U, 188U, 192U, 4134U, 4145U };
  ...
  static size_t selector_X_[14] = { 476U, 477U, 479U, 480U, 481U, 482U, 483U,
    484U, 506U, 508U, 509U, 510U, 511U, 512U };
  ...
  static int32_T mode_indices_[2] = { 2, 3 };

  static PmIntVector mode_indices = { 2U, mode_indices_ };

  static int32_T m_ref_indices_[4] = { 0, 1, 4, 5 };
