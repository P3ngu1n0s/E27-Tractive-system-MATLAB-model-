...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_26f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_26(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4010U, 4011U };
  ...
  static size_t selector_X_[3] = { 2549U, 2558U, 2559U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_26xnplus1;
