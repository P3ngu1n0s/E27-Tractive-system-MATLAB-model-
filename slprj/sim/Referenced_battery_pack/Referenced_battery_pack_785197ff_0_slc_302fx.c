...
int32_T Referenced_battery_pack_785197ff_0_slc_302fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t0.mField0[0UL], &t0.mField2[0UL],
    &t1.mField0[0UL], &t1.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_Five1_Battery_Table_Based9_electricalModel_xVint = t27[0UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t0.mField0[0UL], &t0.mField2[0UL],
    ...
    &t5[0UL]);
  intrm_sf_mf_55 = t27[0UL];
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t1.mField0[0UL], &t1.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  if (t42->mM.mX[1UL] != 0) {
    zc_int165 = 8.200000000000002E-8;
  } else {
    zc_int165 = intrm_sf_mf_55;
  }
  ...
  if (t42->mM.mX[0UL] != 0) {
    ...
    intrm_sf_mf_55 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_55 =
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    zc_int25 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int25 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    ...
    ((((((t42->mX.mX[3UL] * zc_int165 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
