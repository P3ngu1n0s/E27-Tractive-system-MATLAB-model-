...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_263f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_263(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 270U, 278U, 279U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_263xnplus1;
