...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_92f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_92(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3863U, 3864U };
  ...
  static size_t selector_X_[3] = { 1892U, 1899U, 1900U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_92xnplus1;
