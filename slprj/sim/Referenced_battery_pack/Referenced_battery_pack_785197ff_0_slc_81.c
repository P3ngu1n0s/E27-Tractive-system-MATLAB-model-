...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_81f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_81(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3888U, 3889U };
  ...
  static size_t selector_X_[3] = { 2001U, 2008U, 2009U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_81xnplus1;
