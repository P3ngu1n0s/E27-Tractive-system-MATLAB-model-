...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_406jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_406fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_406(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 228U, 234U, 713U, 724U, 846U, 857U };
  ...
  static size_t selector_X_[15] = { 752U, 813U, 830U, 831U, 833U, 834U, 835U,
    836U, 837U, 888U, 890U, 891U, 892U, 893U, 894U };
