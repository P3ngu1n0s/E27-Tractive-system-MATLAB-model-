...
int32_T Referenced_battery_pack_785197ff_0_slc_49f(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t33, SlcMethodOutput *out)
{
  ...
  if (t33->mM.mX[0UL] != 0) {
    ...
    t2 = Accumalator_Module_four_Battery_Table_Based16_stateOfCharge;
  }

  Accumalator_Module_four_Battery_Table_Based16_stateOfCharge = 1.0 / (t2 == 0.0
    ? 1.0E-16 : t2);
  if (t33->mM.mX[1UL] != 0) {
    t20[0UL] = 0UL;
    for (t24 = 0UL; t24 < 80UL; t24++) {
  ...
  out->mF.mX[0UL] = -Accumalator_Module_four_Battery_Table_Based16_stateOfCharge;
