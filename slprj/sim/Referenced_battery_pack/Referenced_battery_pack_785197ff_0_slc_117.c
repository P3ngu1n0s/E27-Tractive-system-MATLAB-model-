...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_117f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_117(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3808U, 3809U };
  ...
  static size_t selector_X_[3] = { 1637U, 1644U, 1645U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_117xnplus1;
