  ...
  *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t7[0UL], &t0.mField0[0UL], &t0.mField2[0UL],
    ...
    &t6[0UL]);
  Accumalator_Module_Two_Battery_Table_Based31_stateOfCharge = t7[0UL];
  ...
  if (t33->mM.mX[0UL] != 0) {
    ...
    Accumalator_Module_Two_Battery_Table_Based31_stateOfCharge = nonscalar9[t20
  ...
  Accumalator_Module_Two_Battery_Table_Based31_stateOfCharge = -(1.0 /
    (Accumalator_Module_Two_Battery_Table_Based31_stateOfCharge == 0.0 ? 1.0E-16
