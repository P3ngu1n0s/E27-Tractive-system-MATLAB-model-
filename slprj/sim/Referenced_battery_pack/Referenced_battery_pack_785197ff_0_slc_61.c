...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_61f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_61(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3932U, 3933U };
  ...
  static size_t selector_X_[3] = { 2196U, 2203U, 2204U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_61xnplus1;
