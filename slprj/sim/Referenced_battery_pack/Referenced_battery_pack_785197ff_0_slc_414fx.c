...
int32_T Referenced_battery_pack_785197ff_0_slc_414fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_One1_Battery_Table_Based11_electricalModel_v = -t42->mX.mX
    [2UL] + t42->mX.mX[3UL];
  t27[0UL] = t42->mX.mX[0UL] * 5.5555555555555558E-5;
  ...
  tlu2_2d_linear_nearest_value(&t25[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_One1_Battery_Table_Based14_stateOfCharge = t27[0UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    ...
    &t5[0UL]);
  intrm_sf_mf_58 = t27[0UL];
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t0.mField0[0UL], &t0.mField2[0UL], &nonscalar3[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  if (t42->mM.mX[1UL] != 0) {
    zc_int174 = 8.200000000000002E-8;
  } else {
    zc_int174 = intrm_sf_mf_58;
  }
  ...
  if (t42->mM.mX[0UL] != 0) {
    ...
    intrm_sf_mf_58 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    intrm_sf_mf_58 = t25[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based14_stateOfCharge = nonscalar0[t4
      [0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  }

  out->mFX.mX[0UL] =
    Accumalator_Module_One1_Battery_Table_Based11_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int174 + t42->mX.mX[4UL]) +
  ...
  out->mFX.mX[1UL] =
    ...
    ((((((t42->mX.mX[1UL] *
          Accumalator_Module_One1_Battery_Table_Based11_stateOfCharge +
          t42->mX.mX[10UL]) + t42->mX.mX[11UL]) + t42->mX.mX[12UL]) + t42->
