...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_27f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_27(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4008U, 4009U };
  ...
  static size_t selector_X_[3] = { 2540U, 2547U, 2548U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_27xnplus1;
