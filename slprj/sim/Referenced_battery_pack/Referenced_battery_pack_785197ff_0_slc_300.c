...
static int32_T slc_jnl_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_300jnl(ds, in, out);
...
static int32_T slc_fx_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_300fx(ds, in, out);
  partitioning_slc_scale_vector_method(ds, out);
  return 0;
}

SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_300(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[6] = { 2U, 113U, 139U, 142U, 3334U, 3645U };
  ...
  static size_t selector_X_[15] = { 24U, 25U, 26U, 28U, 29U, 30U, 31U, 32U, 33U,
    59U, 61U, 62U, 63U, 64U, 65U };
