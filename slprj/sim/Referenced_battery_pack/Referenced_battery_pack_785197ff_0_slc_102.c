...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_102f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_102(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3841U, 3842U };
  ...
  static size_t selector_X_[3] = { 1791U, 1798U, 1799U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_102xnplus1;
