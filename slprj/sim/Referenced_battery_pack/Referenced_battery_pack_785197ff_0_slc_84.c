...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_84f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_84(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3882U, 3883U };
  ...
  static size_t selector_X_[3] = { 1972U, 1979U, 1980U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_84xnplus1;
