...
#include "Referenced_battery_pack_785197ff_0_slc_420jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_420jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t19[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    ...
    &t5[0UL]);
  t12[0UL] = t20->mX.mX[0UL] * 5.5555555555555558E-5;
  tlu2_linear_nearest_prelookup(&t2.mField0[0UL], &t2.mField1[0UL], &t2.mField2
    [0UL], &nonscalar1[0UL], &t12[0UL], &t4[0UL], &t5[0UL]);
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based12_stateOfCharge = t19[0UL];
  }

  out->mJNL.mX[0UL] = zc_int177;
  out->mJNL.mX[1UL] =
    -Accumalator_Module_One1_Battery_Table_Based12_stateOfCharge;
  (void)sys;
  (void)out;
