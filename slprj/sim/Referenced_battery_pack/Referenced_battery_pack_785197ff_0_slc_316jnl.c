...
int32_T Referenced_battery_pack_785197ff_0_slc_316jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    intrm_sf_mf_260 = 8.200000000000002E-8;
  } else {
    intrm_sf_mf_260 = t12[0UL];
  }

  out->mJNL.mX[0UL] = -intrm_sf_mf_260;
  out->mJNL.mX[1UL] = zc_int780;
  (void)sys;
  (void)out;
  return 0;
}
