...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_256f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_256(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 328U, 335U, 336U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_256xnplus1;
