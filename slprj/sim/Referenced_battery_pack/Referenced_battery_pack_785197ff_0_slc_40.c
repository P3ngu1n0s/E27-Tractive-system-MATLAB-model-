...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_40f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_40(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3980U, 3981U };
  ...
  static size_t selector_X_[3] = { 2413U, 2420U, 2421U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_40xnplus1;
