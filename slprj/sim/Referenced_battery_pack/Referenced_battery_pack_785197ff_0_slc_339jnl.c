...
#include "Referenced_battery_pack_785197ff_0_slc_339jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_339jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_Three1_Battery_Table_Based52_stateOfCharge = t12[0UL];
  }

  out->mJNL.mX[0UL] =
    -Accumalator_Module_Three1_Battery_Table_Based52_stateOfCharge;
  out->mJNL.mX[1UL] = zc_int477;
  (void)sys;
  (void)out;
  return 0;
}
