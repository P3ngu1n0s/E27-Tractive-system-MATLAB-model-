...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_297f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_297(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4074U, 4075U };
  ...
  static size_t selector_X_[3] = { 36U, 46U, 47U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_297xnplus1;
