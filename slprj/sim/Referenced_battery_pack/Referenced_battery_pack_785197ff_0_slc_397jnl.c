...
#include "Referenced_battery_pack_785197ff_0_slc_397jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_397jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based47_stateOfCharge = t19[0UL];
  }

  out->mJNL.mX[0UL] =
    -Accumalator_Module_One1_Battery_Table_Based47_stateOfCharge;
  out->mJNL.mX[1UL] = zc_int291;
  (void)sys;
  (void)out;
  return 0;
}
