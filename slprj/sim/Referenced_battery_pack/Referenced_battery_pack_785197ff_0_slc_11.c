...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_11f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_11(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4043U, 4044U };
  ...
  static size_t selector_X_[3] = { 2697U, 2704U, 2705U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_11xnplus1;
