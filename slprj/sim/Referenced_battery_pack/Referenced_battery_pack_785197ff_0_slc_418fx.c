...
int32_T Referenced_battery_pack_785197ff_0_slc_418fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  real_T Accumalator_Module_One1_Battery_Table_Based1_electricalModel_xVint;
  ...
  size_t t34;
  size_t t36;
  Accumalator_Module_One1_Battery_Table_Based1_electricalModel_v = -t42->mX.mX
    [2UL] + t42->mX.mX[3UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    &t1.mField0[0UL], &t1.mField2[0UL], &nonscalar0[0UL], &t4[0UL], &t7[0UL],
    &t5[0UL]);
  Accumalator_Module_One1_Battery_Table_Based32_stateOfCharge = t27[0UL];
  ...
  tlu2_2d_linear_nearest_value(&t27[0UL], &t2.mField0[0UL], &t2.mField2[0UL],
    ...
    &t5[0UL]);
  if (t42->mM.mX[1UL] != 0) {
    zc_int168 = 8.200000000000002E-8;
  } else {
    zc_int168 = zc_int169;
  }
  ...
  if (t42->mM.mX[0UL] != 0) {
    ...
    zc_int169 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int169 = t25[0UL];
  }
  ...
  if (t42->mM.mX[5UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based1_electricalModel_xVint = t27[0UL];
  }
  ...
  if (t42->mM.mX[4UL] != 0) {
    ...
    Accumalator_Module_One1_Battery_Table_Based32_stateOfCharge = nonscalar0[t4
  ...
  out->mFX.mX[1UL] =
    Accumalator_Module_One1_Battery_Table_Based1_electricalModel_v -
    (((((((-t42->mX.mX[1UL] - t42->mU.mX[0UL]) * zc_int168 + t42->mX.mX[4UL]) +
