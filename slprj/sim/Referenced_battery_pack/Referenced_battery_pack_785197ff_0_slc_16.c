...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_16f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_16(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4032U, 4033U };
  ...
  static size_t selector_X_[3] = { 2650U, 2657U, 2658U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_16xnplus1;
