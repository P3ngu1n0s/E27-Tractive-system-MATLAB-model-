...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_52f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_52(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3952U, 3953U };
  ...
  static size_t selector_X_[3] = { 2289U, 2298U, 2299U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_52xnplus1;
