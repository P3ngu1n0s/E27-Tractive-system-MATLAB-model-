...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_178f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_178(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1025U, 1034U, 1035U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_178xnplus1;
