...
int32_T Referenced_battery_pack_785197ff_0_slc_365fx(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t42, SlcMethodOutput *out)
{
  ...
  if (t42->mM.mX[2UL] != 0) {
    ...
    zc_int349 = nonscalar0[t4[0UL] > 39UL ? 39UL : t4[0UL]] * 1.0E-5;
  } else {
    zc_int349 = t25[0UL];
  }
  ...
  out->mFX.mX[0UL] =
    Accumalator_Module_Three1_Battery_Table_Based13_electricalModel_v -
    (((((((-t42->mX.mX[2UL] - t42->mU.mX[0UL]) * zc_int348 + t42->mX.mX[4UL]) +
         t42->mX.mX[5UL]) + t42->mX.mX[6UL]) + t42->mX.mX[7UL]) + t42->mX.mX[8UL])
     + zc_int349);
  out->mFX.mX[1UL] =
    Accumalator_Module_Three1_Battery_Table_Based13_electricalModel_v -
    ((((((t42->mX.mX[2UL] * zc_int492 + t42->mX.mX[10UL]) + t42->mX.mX[11UL]) +
