...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_121f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_121(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3799U, 3800U };
  ...
  static size_t selector_X_[3] = { 1597U, 1607U, 1608U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_121xnplus1;
