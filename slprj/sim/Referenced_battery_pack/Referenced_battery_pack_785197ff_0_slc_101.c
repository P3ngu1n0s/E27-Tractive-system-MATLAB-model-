...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_101f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_101(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3843U, 3844U };
  ...
  static size_t selector_X_[3] = { 1800U, 1808U, 1809U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_101xnplus1;
