  ...
  *out)
{
  ...
  if (t33->mM.mX[0UL] != 0) {
    ...
    intrm_sf_mf_1804 = nonscalar9[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  intrm_sf_mf_1804 = -(1.0 / (intrm_sf_mf_1804 == 0.0 ? 1.0E-16 :
    intrm_sf_mf_1804));
  out->mXNPLUS1.mX[0UL] = -intrm_sf_mf_1804;
