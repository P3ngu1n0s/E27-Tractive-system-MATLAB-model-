...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_150f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_150(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3735U, 3736U };
  ...
  static size_t selector_X_[3] = { 1311U, 1320U, 1321U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_150xnplus1;
