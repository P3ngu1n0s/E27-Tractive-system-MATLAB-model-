...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_165f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_165(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 1157U, 1167U, 1168U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_165xnplus1;
