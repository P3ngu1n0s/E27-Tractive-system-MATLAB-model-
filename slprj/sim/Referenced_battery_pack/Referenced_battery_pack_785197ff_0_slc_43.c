...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_43f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_43(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 2381U, 2391U, 2392U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_43xnplus1;
