...
#include "Referenced_battery_pack_785197ff_0_slc_308jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_308jnl(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t20, SlcMethodOutput *out)
{
  ...
  if (t20->mM.mX[3UL] != 0) {
    ...
    intrm_sf_mf_44 = t19[0UL];
  }

  out->mJNL.mX[0UL] = intrm_sf_mf_44;
  out->mJNL.mX[1UL] = -zc_int132;
  (void)sys;
  (void)out;
  return 0;
}
