...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_202f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_202(PmAllocator
  *allocator)
{
  ...
  static size_t selector_X_[3] = { 797U, 807U, 808U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_202xnplus1;
