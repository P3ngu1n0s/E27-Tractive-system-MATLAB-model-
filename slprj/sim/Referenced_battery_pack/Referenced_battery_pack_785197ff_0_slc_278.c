...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Referenced_battery_pack_785197ff_0_slc_278f(ds, in, out);
...
SwitchedLinearClump *Referenced_battery_pack_785197ff_0_slc_278(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 4104U, 4105U };
  ...
  static size_t selector_X_[3] = { 172U, 179U, 180U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Referenced_battery_pack_785197ff_0_slc_278xnplus1;
