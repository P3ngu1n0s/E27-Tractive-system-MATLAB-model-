...
int32_T Referenced_battery_pack_785197ff_0_slc_411jnl ( const
...
zc_int210 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int210 =
8.200000000000002E-8 ; } else { zc_int210 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
...
out -> mJNL . mX [ 0UL ] = -
Accumalator_Module_One1_Battery_Table_Based22_stateOfCharge ; out -> mJNL .
mX [ 1UL ] = zc_int210 ; ( void ) sys ; ( void ) out ; return 0 ; }
