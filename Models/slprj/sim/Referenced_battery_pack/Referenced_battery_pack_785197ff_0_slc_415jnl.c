...
#include "Referenced_battery_pack_785197ff_0_slc_415jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_415jnl ( const
...
real_T t12 [ 1 ] ; real_T t19 [ 1 ] ; real_T intrm_sf_mf_64 ; real_T
zc_int192 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; nonscalar1
...
[ 2 ] = _cg_const_2 [ 2 ] ; nonscalar2 [ 3 ] = _cg_const_2 [ 3 ] ; t12 [ 0UL
] = t20 -> mX . mX [ 9UL ] * 5.5555555555555558E-5 ; nonscalar3 [ 0 ] =
...
] = t20 -> mX . mX [ 2UL ] * 5.5555555555555558E-5 ;
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int192 =
8.200000000000002E-8 ; } else { zc_int192 = t12 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) { intrm_sf_mf_64 = 8.200000000000002E-8 ; } else {
intrm_sf_mf_64 = t19 [ 0UL ] ; } out -> mJNL . mX [ 0UL ] = - intrm_sf_mf_64
; out -> mJNL . mX [ 1UL ] = zc_int192 ; ( void ) sys ; ( void ) out ; return
0 ; }
