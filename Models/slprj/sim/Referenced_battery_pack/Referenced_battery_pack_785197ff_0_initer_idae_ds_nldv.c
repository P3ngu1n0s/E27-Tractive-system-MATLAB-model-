...
#include "Referenced_battery_pack_785197ff_0_initer_idae_ds_nldv.h"
...
out ) { static boolean_T _cg_const_1 [ 2801 ] = { true , false , false ,
...
, false , true , false , false , false , false , false , false , false ,
false , true , false , false , false , false , false , false , false , false
, false } ; int32_T i ; ( void ) t1 ; ( void ) LC ; for ( i = 0 ; i < 2801 ;
i ++ ) { out -> mNLDV . mX [ i ] = _cg_const_1 [ i ] ; } ( void ) LC ; ( void
) out ; return 0 ; }
