...
#include "Referenced_battery_pack_785197ff_0_slc_252jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_252jnl ( const
...
zc_int114 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int114 =
8.200000000000002E-8 ; } else { zc_int114 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
Accumalator_Module_Five1_Battery_Table_Based44_stateOfCharge =
8.200000000000002E-8 ; } else {
Accumalator_Module_Five1_Battery_Table_Based44_stateOfCharge = t12 [ 0UL ] ;
} out -> mJNL . mX [ 0UL ] = zc_int114 ; out -> mJNL . mX [ 1UL ] = -
Accumalator_Module_Five1_Battery_Table_Based44_stateOfCharge ; ( void ) sys ;
( void ) out ; return 0 ; }
