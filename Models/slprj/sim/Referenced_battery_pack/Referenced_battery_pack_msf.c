...
#define S_FUNCTION_NAME Referenced_battery_pack_msf
#endif
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; gufsl3zicl ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; cg355dq0z1 ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; real_T const * i_o5uirw4zg2 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 ) { Referenced_battery_pack ( & ( dw -> rtm ) , i_o5uirw4zg2 , o_B_3_1 , o_B_3_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; guuukyvztk ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 1 , 2 ) ; if ( ! ssSetNumInputPorts ( S , 1 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "V" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 1 , unitIdReg ) ;
#endif
...
mr_Referenced_battery_pack_RegisterSimStateChecksum ( S ) ;
...
mr_Referenced_battery_pack_MdlInfoRegFcn ( S , "Referenced_battery_pack" , &
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( lax0vklohkm ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; ssNonContDerivSigFeedingOutports mr_nonContOutput1 [ 1 ] ; ssNonContDerivSigFeedingOutports * mr_nonContOutputArray [ 2 ] ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } mr_nonContOutputArray [ 0 ] = ( NULL ) ; mr_nonContOutputArray [ 1 ] = mr_nonContOutput1 ; asggnlvkgn ( S , mr_nonContOutputArray , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 2 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 3 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 1 , mr_nonContOutput1 ) ) return ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { lax0vklohkm * dw = ( lax0vklohkm * )
ssGetDWork ( S , 0 ) ; cfw4m2n3fw ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; real_T const * i_o5uirw4zg2 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { Referenced_battery_pack ( & ( dw -> rtm ) , i_o5uirw4zg2 , o_B_3_1 , o_B_3_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; guuukyvztk ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { lax0vklohkm * dw = ( lax0vklohkm * ) ssGetDWork ( S , 0 ) ; bodshmi05b ( & ( dw -> rtdw ) , & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_Referenced_battery_pack_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_Referenced_battery_pack_GetSimStateDisallowedBlocks ( ) ;
...
mr_Referenced_battery_pack_SetDWork ( ssGetDWork ( S , 0 ) ,
