...
#include "Referenced_battery_pack_785197ff_0_slc_364jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_364jnl ( const
...
zc_int345 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
] = 298.15 ; t7 [ 0 ] = 4UL ; tlu2_linear_nearest_prelookup ( & t1 . mField0
[ 0UL ] , & t1 . mField1 [ 0UL ] , & t1 . mField2 [ 0UL ] , & nonscalar2 [
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int345 =
8.200000000000002E-8 ; } else { zc_int345 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
Accumalator_Module_Three1_Battery_Table_Based12_stateOfCharge =
8.200000000000002E-8 ; } else {
Accumalator_Module_Three1_Battery_Table_Based12_stateOfCharge = t12 [ 0UL ] ;
} out -> mJNL . mX [ 0UL ] = zc_int345 ; out -> mJNL . mX [ 1UL ] = -
Accumalator_Module_Three1_Battery_Table_Based12_stateOfCharge ; ( void ) sys
; ( void ) out ; return 0 ; }
