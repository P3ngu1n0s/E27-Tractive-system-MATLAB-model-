...
#include "Referenced_battery_pack_785197ff_0_slc_372jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_372jnl ( const
...
real_T t12 [ 1 ] ; real_T t19 [ 1 ] ; real_T intrm_sf_mf_204 ; real_T
zc_int612 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
= t20 -> mX . mX [ 0UL ] * 5.5555555555555558E-5 ; nonscalar1 [ 0 ] =
...
t0 . mField0 [ 0UL ] , & t0 . mField1 [ 0UL ] , & t0 . mField2 [ 0UL ] , &
nonscalar1 [ 0UL ] , & t12 [ 0UL ] , & t4 [ 0UL ] , & t5 [ 0UL ] ) ; t12 [ 0
] = 298.15 ; t7 [ 0 ] = 4UL ; tlu2_linear_nearest_prelookup ( & t2 . mField0
[ 0UL ] , & t2 . mField1 [ 0UL ] , & t2 . mField2 [ 0UL ] , & nonscalar2 [
0UL ] , & t12 [ 0UL ] , & t7 [ 0UL ] , & t5 [ 0UL ] ) ;
tlu2_2d_linear_nearest_value ( & t19 [ 0UL ] , & t0 . mField0 [ 0UL ] , & t0
...
] , & t0 . mField2 [ 0UL ] , & nonscalar1 [ 0UL ] , & t12 [ 0UL ] , & t4 [
0UL ] , & t5 [ 0UL ] ) ; tlu2_2d_linear_nearest_value ( & t12 [ 0UL ] , & t0
. mField0 [ 0UL ] , & t0 . mField2 [ 0UL ] , & t2 . mField0 [ 0UL ] , & t2 .
mField2 [ 0UL ] , & nonscalar3 [ 0UL ] , & t4 [ 0UL ] , & t7 [ 0UL ] , & t5 [
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int612 =
8.200000000000002E-8 ; } else { zc_int612 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) { intrm_sf_mf_204 = 8.200000000000002E-8 ; } else {
intrm_sf_mf_204 = t12 [ 0UL ] ; } out -> mJNL . mX [ 0UL ] = -
intrm_sf_mf_204 ; out -> mJNL . mX [ 1UL ] = zc_int612 ; ( void ) sys ; ( void
) out ; return 0 ; }
