...
int32_T Referenced_battery_pack_785197ff_0_slc_397jnl ( const
...
zc_int291 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; nonscalar1
...
] = t20 -> mX . mX [ 1UL ] * 5.5555555555555558E-5 ;
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int291 =
8.200000000000002E-8 ; } else { zc_int291 = t12 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
...
out -> mJNL . mX [ 0UL ] = -
Accumalator_Module_One1_Battery_Table_Based47_stateOfCharge ; out -> mJNL .
mX [ 1UL ] = zc_int291 ; ( void ) sys ; ( void ) out ; return 0 ; }
