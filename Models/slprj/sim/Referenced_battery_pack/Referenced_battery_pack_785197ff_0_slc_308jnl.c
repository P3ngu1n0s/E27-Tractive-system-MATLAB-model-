...
int32_T Referenced_battery_pack_785197ff_0_slc_308jnl ( const
...
real_T t12 [ 1 ] ; real_T t19 [ 1 ] ; real_T intrm_sf_mf_44 ; real_T
zc_int132 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 5UL ] != 0 ) { zc_int132 =
8.200000000000002E-8 ; } else { zc_int132 = t12 [ 0UL ] ; } if ( t20 -> mM .
mX [ 3UL ] != 0 ) { intrm_sf_mf_44 = 8.200000000000002E-8 ; } else {
intrm_sf_mf_44 = t19 [ 0UL ] ; } out -> mJNL . mX [ 0UL ] = intrm_sf_mf_44 ;
out -> mJNL . mX [ 1UL ] = - zc_int132 ; ( void ) sys ; ( void ) out ; return
0 ; }
