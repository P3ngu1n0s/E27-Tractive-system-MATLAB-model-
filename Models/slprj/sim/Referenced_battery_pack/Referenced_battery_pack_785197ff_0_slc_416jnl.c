...
int32_T Referenced_battery_pack_785197ff_0_slc_416jnl ( const
...
real_T t12 [ 1 ] ; real_T t19 [ 1 ] ; real_T intrm_sf_mf_57 ; real_T
zc_int171 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 1UL ] != 0 ) { zc_int171 =
8.200000000000002E-8 ; } else { zc_int171 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) { intrm_sf_mf_57 = 8.200000000000002E-8 ; } else {
intrm_sf_mf_57 = t12 [ 0UL ] ; } out -> mJNL . mX [ 0UL ] = - intrm_sf_mf_57
; out -> mJNL . mX [ 1UL ] = zc_int171 ; ( void ) sys ; ( void ) out ; return
0 ; }
