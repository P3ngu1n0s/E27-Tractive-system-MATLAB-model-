...
out ) { static boolean_T _cg_const_1 [ 7560 ] = { false , false , true , true
...
false , true , true , false , false , false , true , true , false , false ,
false , true , true , false , false , false , true , true , false , false ,
false , true , true , false , false , false } ; int32_T i ; ( void ) t1 ; ( void
) LC ; for ( i = 0 ; i < 7560 ; i ++ ) { out -> mVMM . mX [ i ] = _cg_const_1
