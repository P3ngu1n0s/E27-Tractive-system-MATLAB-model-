...
#include "Referenced_battery_pack_785197ff_0_slc_325jnl.h"
...
int32_T Referenced_battery_pack_785197ff_0_slc_325jnl ( const
...
zc_int717 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int717 =
8.200000000000002E-8 ; } else { zc_int717 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
Accumalator_Module_four_Battery_Table_Based23_stateOfCharge =
8.200000000000002E-8 ; } else {
Accumalator_Module_four_Battery_Table_Based23_stateOfCharge = t12 [ 0UL ] ; }
out -> mJNL . mX [ 0UL ] = -
Accumalator_Module_four_Battery_Table_Based23_stateOfCharge ; out -> mJNL .
mX [ 1UL ] = zc_int717 ; ( void ) sys ; ( void ) out ; return 0 ; }
