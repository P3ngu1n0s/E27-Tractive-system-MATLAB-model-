...
int32_T Referenced_battery_pack_785197ff_0_slc_420jnl ( const
...
zc_int177 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; nonscalar1
...
] = t20 -> mX . mX [ 0UL ] * 5.5555555555555558E-5 ;
...
0UL ] ) ; if ( t20 -> mM . mX [ 2UL ] != 0 ) { zc_int177 =
8.200000000000002E-8 ; } else { zc_int177 = t12 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
...
out -> mJNL . mX [ 0UL ] = zc_int177 ; out -> mJNL . mX [ 1UL ] = -
Accumalator_Module_One1_Battery_Table_Based12_stateOfCharge ; ( void ) sys ;
( void ) out ; return 0 ; }
