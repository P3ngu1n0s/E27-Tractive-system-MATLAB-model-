...
int32_T Referenced_battery_pack_785197ff_0_slc_332jnl ( const
...
real_T t12 [ 1 ] ; real_T t19 [ 1 ] ; real_T intrm_sf_mf_225 ; real_T
zc_int675 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int675 =
8.200000000000002E-8 ; } else { zc_int675 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) { intrm_sf_mf_225 = 8.200000000000002E-8 ; } else {
intrm_sf_mf_225 = t12 [ 0UL ] ; } out -> mJNL . mX [ 0UL ] = -
intrm_sf_mf_225 ; out -> mJNL . mX [ 1UL ] = zc_int675 ; ( void ) sys ; ( void
) out ; return 0 ; }
