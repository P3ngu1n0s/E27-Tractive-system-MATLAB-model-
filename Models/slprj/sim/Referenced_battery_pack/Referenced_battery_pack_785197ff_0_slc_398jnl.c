...
int32_T Referenced_battery_pack_785197ff_0_slc_398jnl ( const
...
zc_int273 ; size_t t4 [ 1 ] ; size_t t5 [ 1 ] ; size_t t7 [ 1 ] ; t12 [ 0UL ]
...
0UL ] ) ; if ( t20 -> mM . mX [ 3UL ] != 0 ) { zc_int273 =
8.200000000000002E-8 ; } else { zc_int273 = t19 [ 0UL ] ; } if ( t20 -> mM .
mX [ 5UL ] != 0 ) {
...
out -> mJNL . mX [ 0UL ] = zc_int273 ; out -> mJNL . mX [ 1UL ] = -
Accumalator_Module_One1_Battery_Table_Based41_stateOfCharge ; ( void ) sys ;
( void ) out ; return 0 ; }
