...
#include "Tractive_System_model_2f85d999_0_slc_81_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_81xnplus1(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t7[0UL], &t1.mField0[0UL], &t1.mField2[0UL],
    ...
    &t6[0UL]);
  Accumalator_Module_Two_Battery_Table_Based38_stateOfCharge = t7[0UL];
  ...
  Accumalator_Module_Two_Battery_Table_Based38_stateOfCharge = -(1.0 /
    (Accumalator_Module_Two_Battery_Table_Based38_stateOfCharge == 0.0 ? 1.0E-16
     : Accumalator_Module_Two_Battery_Table_Based38_stateOfCharge));
  out->mXNPLUS1.mX[0UL] =
    -Accumalator_Module_Two_Battery_Table_Based38_stateOfCharge;
