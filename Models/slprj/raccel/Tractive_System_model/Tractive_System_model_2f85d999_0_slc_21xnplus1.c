...
#include "Tractive_System_model_2f85d999_0_slc_21_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_21xnplus1(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    zc_int1904 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  zc_int1904 = -(1.0 / (zc_int1904 == 0.0 ? 1.0E-16 : zc_int1904));
  out->mXNPLUS1.mX[0UL] = -zc_int1904;
