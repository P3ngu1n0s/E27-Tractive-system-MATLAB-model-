...
#include "Tractive_System_model_2f85d999_0_slc_90_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_90xnplus1(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  tlu2_2d_linear_nearest_value(&t7[0UL], &t0.mField0[0UL], &t0.mField2[0UL],
    &t1.mField0[0UL], &t1.mField2[0UL], &nonscalar12[0UL], &t20[0UL], &t8[0UL],
    &t6[0UL]);
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    Accumalator_Module_Two_Battery_Table_Based3_stateOfCharge = nonscalar11[t20
  ...
  if (t40->mM.mX[1UL] != 0) {
    ...
    t3 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  } else {
    t3 = t7[0UL];
  }
