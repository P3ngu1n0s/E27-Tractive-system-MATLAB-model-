...
int32_T Tractive_System_model_2f85d999_0_slc_206f(const SwitchedLinearClump *sys,
  const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  out->mF.mX[0UL] = -Accumalator_Module_One1_Battery_Table_Based26_stateOfCharge;
