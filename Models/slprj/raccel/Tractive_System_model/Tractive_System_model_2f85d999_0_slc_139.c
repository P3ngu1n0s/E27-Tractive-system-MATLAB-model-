...
#include "Tractive_System_model_2f85d999_0_slc_139xnplus1.h"
#include "Tractive_System_model_2f85d999_0_slc_139f.h"
#include "ssc_ml_fun.h"
#include "Tractive_System_model_2f85d999_0_slc_139_external_struct.h"
#include "Tractive_System_model_2f85d999_0_slc_139_externals.h"
...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Tractive_System_model_2f85d999_0_slc_139f(ds, in, out);
...
SwitchedLinearClump *Tractive_System_model_2f85d999_0_slc_139(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3784U, 3785U };
  ...
  static size_t selector_X_[3] = { 1428U, 1435U, 1436U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Tractive_System_model_2f85d999_0_slc_139xnplus1;
  ...
  NeDynamicSystemInput *t3, SlcMethodOutput *out)
{
  ...
  out->mFX.mX[0UL] = piece3[1UL];
  out->mFX.mX[1UL] = piece3[0UL];
  (void)sys;
  (void)out;
  return 0;
}
...
{
  (void)t7;
  out->mJCON.mX[0UL] = 0.0;
  out->mJCON.mX[1UL] = 1.0;
  out->mJCON.mX[2UL] = 1.0;
  out->mJCON.mX[3UL] = 0.0;
  (void)sys;
  (void)out;
  return 0;
}
