...
#include "Tractive_System_model_2f85d999_0_slc_146xnplus1.h"
...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Tractive_System_model_2f85d999_0_slc_146f(ds, in, out);
...
SwitchedLinearClump *Tractive_System_model_2f85d999_0_slc_146(PmAllocator
  *allocator)
{
  ...
  static size_t selector_M_[2] = { 3768U, 3769U };
  ...
  static size_t selector_X_[3] = { 1357U, 1364U, 1365U };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Tractive_System_model_2f85d999_0_slc_146xnplus1;
