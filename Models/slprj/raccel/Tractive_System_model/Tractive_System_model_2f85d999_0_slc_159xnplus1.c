...
#include "Tractive_System_model_2f85d999_0_slc_159_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_159xnplus1(const
  ...
  *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    intrm_sf_mf_1006 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  intrm_sf_mf_1006 = -(1.0 / (intrm_sf_mf_1006 == 0.0 ? 1.0E-16 :
    intrm_sf_mf_1006));
  out->mXNPLUS1.mX[0UL] = -intrm_sf_mf_1006;
