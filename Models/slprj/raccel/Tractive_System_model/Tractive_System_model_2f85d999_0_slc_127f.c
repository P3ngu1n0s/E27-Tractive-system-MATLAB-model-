...
int32_T Tractive_System_model_2f85d999_0_slc_127f(const SwitchedLinearClump *sys,
  const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    t2 = Accumalator_Module_Three1_Battery_Table_Based47_stateOfCharge;
  }

  Accumalator_Module_Three1_Battery_Table_Based47_stateOfCharge = 1.0 / (t2 ==
    0.0 ? 1.0E-16 : t2);
  if (t40->mM.mX[1UL] != 0) {
    t20[0UL] = 0UL;
    for (t24 = 0UL; t24 < 80UL; t24++) {
