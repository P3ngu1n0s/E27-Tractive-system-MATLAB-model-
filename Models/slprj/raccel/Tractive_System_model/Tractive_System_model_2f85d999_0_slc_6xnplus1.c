...
#include "Tractive_System_model_2f85d999_0_slc_6_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_6xnplus1(const SwitchedLinearClump *
  sys, const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    zc_int1949 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
