...
#include "Tractive_System_model_2f85d999_0_slc_38_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_38xnplus1(const SwitchedLinearClump
  *sys, const NeDynamicSystemInput *t40, SlcMethodOutput *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    intrm_sf_mf_1732 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  intrm_sf_mf_1732 = -(1.0 / (intrm_sf_mf_1732 == 0.0 ? 1.0E-16 :
    intrm_sf_mf_1732));
  out->mXNPLUS1.mX[0UL] = -intrm_sf_mf_1732;
