...
#include "Tractive_System_model_2f85d999_0_slc_269_sys_struct.h"
...
int32_T Tractive_System_model_2f85d999_0_slc_269xnplus1(const
  ...
  *out)
{
  ...
  if (t40->mM.mX[0UL] != 0) {
    ...
    zc_int1160 = nonscalar11[t20[0UL] > 79UL ? 79UL : t20[0UL]] * 1.0E-5;
  }
  ...
  out->mXNPLUS1.mX[0UL] = 1.0 / (zc_int1160 == 0.0 ? 1.0E-16 : zc_int1160);
