...
#include "Tractive_System_model_2f85d999_0_slc_145xnplus1.h"
#include "Tractive_System_model_2f85d999_0_slc_145f.h"
#include "ssc_ml_fun.h"
#include "Tractive_System_model_2f85d999_0_slc_145_external_struct.h"
#include "Tractive_System_model_2f85d999_0_slc_145_externals.h"
...
static int32_T slc_f_scaled(const SwitchedLinearClump *ds, const
  NeDynamicSystemInput *in, SlcMethodOutput *out)
{
  Tractive_System_model_2f85d999_0_slc_145f(ds, in, out);
...
SwitchedLinearClump *Tractive_System_model_2f85d999_0_slc_145(PmAllocator
  *allocator)
{
  static NeDynamicSystemInputSizes sizes = { { 0U, 2U, 1U, 0U, 0U, 3U, 0U, 0U,
      0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, } };

  static PmSizeVector selector_Q = { 0U, NULL };

  static size_t selector_M_[2] = { 3770U, 3771U };

  static PmSizeVector selector_M = { 2U, selector_M_ };
  ...
  static size_t selector_X_[3] = { 1366U, 1376U, 1377U };

  static PmSizeVector selector_X = { 3U, selector_X_ };
  ...
  static int32_T state_indices_[2] = { 1, 2 };
  ...
  slc.mMethods[SLC_METHOD_XNPLUS1] =
    Tractive_System_model_2f85d999_0_slc_145xnplus1;
...
static int32_T slc_fx (const SwitchedLinearClump *sys, const
  NeDynamicSystemInput *t3, SlcMethodOutput *out)
{
  real_T piece3[5];
  real_T t1[5];
  size_t t2;
  ...
  t1[3UL] = 0.0;
  t1[4UL] = 0.0;
  for (t2 = 0UL; t2 < 5UL; t2++) {
    piece3[t2] = t1[t2];
  }

  out->mFX.mX[0UL] = piece3[0UL];
  out->mFX.mX[1UL] = piece3[1UL];
  (void)sys;
  (void)out;
  return 0;
}
...
static int32_T slc_jcon (const SwitchedLinearClump *sys, const
  NeDynamicSystemInput *t7, SlcMethodOutput *out)
{
  (void)t7;
  out->mJCON.mX[0UL] = 1.0;
  out->mJCON.mX[1UL] = 0.0;
  out->mJCON.mX[2UL] = 0.0;
...
static int32_T slc_jcon_p (const SwitchedLinearClump *sys, const
  NeDynamicSystemInput *t1, SlcMethodOutput *out)
{
  static int32_T _cg_const_2[4] = { 0, 1, 0, 1 };
